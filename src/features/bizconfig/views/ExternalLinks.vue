      ...
      <el-form label-position="top" :model="form">
        ...
        <el-form-item label="位置" required>
          <el-select v-model="form.position" style="width: 100%">
            ...
            <el-option label="首页主题背景(home_theme_bg)" value="home_theme_bg" />
            <el-option label="首页左浮广位(home_float_left)" value="home_float_left" />
            <el-option label="首页右浮广位(home_float_right)" value="home_float_right" />
