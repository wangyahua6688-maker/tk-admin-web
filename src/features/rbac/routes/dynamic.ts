...
const routeComponentMap: Record<string, () => Promise<unknown>> = {
  ...
  '/user-mgmt/client-users': () => import('@/features/operations/views/ClientUsers.vue'),
  '/user-mgmt/post-articles': () => import('@/features/operations/views/PostArticles.vue'),
  '/user-mgmt/hot-comments': () => import('@/features/operations/views/HotComments.vue'),
  '/biz-config/banners': () => import('@/features/bizconfig/views/BannerConfig.vue'),
  '/biz-config/broadcasts': () => import('@/features/bizconfig/views/BroadcastConfig.vue'),
  '/biz-config/lottery-categories': () => import('@/features/bizconfig/views/LotteryCategoryConfig.vue'),
  '/biz-config/lottery': () => import('@/features/bizconfig/views/LotteryConfig.vue'),
  '/biz-config/official-posts': () => import('@/features/bizconfig/views/OfficialPosts.vue'),
  '/biz-config/external-links': () => import('@/features/bizconfig/views/ExternalLinks.vue'),
  '/biz-config/home-popups': () => import('@/features/bizconfig/views/HomePopupConfig.vue'),
  '/biz-config/sms-channels': () => import('@/features/bizconfig/views/SMSChannelConfig.vue'),
...
const routeTitleFallbackMap: Record<string, string> = {
  '/dashboard': '后台首页',
  '/user-mgmt/client-users': '客户端用户列表',
  '/user-mgmt/post-articles': '帖子管理',
  '/user-mgmt/hot-comments': '热点评论',
  '/biz-config/banners': 'Banner配置',
  '/biz-config/broadcasts': '系统广播配置',
  '/biz-config/lottery-categories': '图库管理',
  '/biz-config/lottery': '开奖区配置',
  '/biz-config/official-posts': '官方发帖管理',
  '/biz-config/external-links': '外链配置',
  '/biz-config/home-popups': '首屏弹窗配置',
  '/biz-config/sms-channels': '短信通道配置',
